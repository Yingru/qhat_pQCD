...
protected:
	...
	double M1, Alpha_s;
public:
	Xsection(double (*dXdPS_)(double *, size_t, void *), double (*approx_X_)(double *, double), double M1_, double Alpha_s_, std::string name_, bool refresh);
...
public:
    Xsection_2to2(double (*dXdPS_)(double *, size_t, void *), double (*approx_X_)(double *, double), double M1_, double Alpha_s_, std::string name_, bool refresh);
...
public:
    Xsection_2to3(double (*dXdPS_)(double *, size_t, void *), double (*approx_X_)(double *, double), double M1_, double Alpha_s_, std::string name_, bool refresh);
	double interpX(double * arg);
    double calculate(double * arg);
	void sample_dXdPS(double * arg, std::vector< std::vector<double> > & FS);
};
...
public:
    f_3to2(double (*dXdPS_)(double *, size_t, void *), double (*approx_X_)(double *, double), double M1_,double Alpha_s_,  std::string name_, bool refresh);
	double interpX(double * arg);
    double calculate(double * arg);
	void sample_dXdPS(double * arg, std::vector< std::vector<double> > & FS);
};
